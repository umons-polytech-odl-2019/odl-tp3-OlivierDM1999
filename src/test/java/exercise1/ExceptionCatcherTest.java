...
public class ExceptionCatcherTest {
	...
	@Test
	public void executeExceptionThrowerSafely_when_throwing_exception() throws Exception {
	...
	@Test
	public void executeExceptionThrowerSafely_when_not_throwing_exception() throws Exception {
